...
<body style="margin:0;padding:0;background-color:#0a0a0a;font-family:Arial,Helvetica,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#0a0a0a;padding:40px 20px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background-color:#142a12;border:1px solid #244a20;border-radius:12px;padding:16px 20px;text-align:center;">
                    ...
                    <p style="margin:6px 0 0;color:#ffffff;font-size:20px;font-weight:700;">${service}</p>
                  </td>
                </tr>
              </table>
            </td>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#111;border:1px solid #2a2a2a;border-radius:12px;overflow:hidden;">
                <tr>
                  <td style="padding:20px 24px;border-bottom:1px solid #2a2a2a;">
                    ...
                    <p style="margin:6px 0 0;color:#ffffff;font-size:16px;font-weight:600;">${name}</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:20px 24px;border-bottom:1px solid #2a2a2a;">
                    ...
                    <p style="margin:6px 0 0;color:#ffffff;font-size:16px;font-weight:600;">
                      <a href="tel:${phone.replace(/\D/g, "")}" style="color:#5fa654;text-decoration:none;">${phone}</a>
                    </p>
                  </td>
                </tr>
                ${
                  email?.trim()
                    ? `<tr>
                  <td style="padding:20px 24px;border-bottom:1px solid #2a2a2a;">
                    <p style="margin:0;color:#808080;font-size:12px;text-transform:uppercase;letter-spacing:1px;">Email Address</p>
                    <p style="margin:6px 0 0;color:#ffffff;font-size:16px;font-weight:600;">
                      <a href="mailto:${email}" style="color:#5fa654;text-decoration:none;">${email}</a>
                    </p>
                  </td>
                </tr>`
                    : ""
                ...
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="margin:0;color:#808080;font-size:12px;text-transform:uppercase;letter-spacing:1px;">Message</p>
                    <p style="margin:10px 0 0;color:#e0e0e0;font-size:15px;line-height:1.6;white-space:pre-wrap;">${message}</p>
                  </td>
                </tr>
              </table>
            </td>
    ...
    if (!emailOk && !smsOk) {
      ...
      console.error("SMS result:", smsResponse);
      return NextResponse.json(
        { error: "Failed to send your message. Please call us at 616-250-8044." },
        { status: 500 }
      );
    }

    if (!emailOk) console.error("Email failed:", emailResult);
    if (!smsOk) console.error("SMS failed:", smsResponse);
