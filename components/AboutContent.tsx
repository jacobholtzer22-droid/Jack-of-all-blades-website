    ...
    <section ref={sectionRef} className="relative pb-24 sm:pb-32 overflow-hidden border-t border-forest-900/30">
      ...
      <div className="relative z-10 max-w-7xl mx-auto section-padding">
        ...
        <div className="reveal opacity-0 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-24 sm:mb-32">
          ...
          <div className="relative aspect-[4/3] rounded-2xl overflow-hidden">
            <Image
              src="/images/paver-patio-seating.webp"
              alt="Custom paver patio with seating area Grand Rapids MI"
              fill
              className="object-cover"
              sizes="(max-width: 640px) 100vw, 33vw"
              quality={75}
          ...
          <div className="relative aspect-[4/3] rounded-2xl overflow-hidden">
            <Image
              src="/images/sod-installation.webp"
              alt="Fresh sod installation Grand Rapids Michigan"
              fill
              className="object-cover"
              sizes="(max-width: 640px) 100vw, 33vw"
              quality={75}
