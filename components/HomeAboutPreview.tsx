      ...
      <div className="relative z-10 max-w-7xl mx-auto section-padding">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            >
              <p className="text-dark-200 leading-relaxed text-[15px] sm:text-base mb-6">
                My name is Mike Hazzard and I am the founder of Jack of All
                Blades Landscaping. I started the business when I was 16, and
                learned from a young age what hard work can do! Ever since then
                I&apos;ve had a passion for running my business and helping each
                and all of my clients.
              </p>
              <p className="text-forest-400 font-semibold text-lg font-heading mb-8">
                Man-made excellence.
              </p>

              <Link
                href="/about"
                className="group inline-flex items-center gap-2 text-forest-400 hover:text-forest-300 font-semibold transition-colors mb-10"
              >
                Read Our Full Story
                <ArrowRight
                  size={18}
