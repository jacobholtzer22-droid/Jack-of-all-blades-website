...
export default function HomeTestimonialPreview() {
  ...
  const testimonial = featured[active];
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto section-padding">
        ...
        <div className="reveal opacity-0 relative bg-dark-800/30 border border-dark-600/20 rounded-3xl p-8 sm:p-12">
          ...
          {/* Carousel controls */}
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-dark-600/20">
            <div className="flex items-center gap-3">
              <button
                onClick={prev}
                aria-label="Previous testimonial"
                className="w-10 h-10 rounded-full border border-dark-600/30 flex items-center justify-center text-dark-300 hover:text-white hover:border-forest-600/40 transition-colors"
              >
                <ChevronLeft size={18} />
              </button>
              <button
        ...
        <div className="reveal opacity-0 flex justify-center mt-8">
          <a
            href={GOOGLE_REVIEW_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-white hover:bg-gray-50 text-dark-900 font-semibold px-6 py-3 rounded-full transition-colors shadow-lg shadow-black/10"
          >
